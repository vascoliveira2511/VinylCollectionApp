          ...
          <div className={styles.contentSection}>
            <div className={styles.userProfileHeader}>
              ...
              <div className={styles.userProfileInfo}>
                ...
                <p>{userData.collections.length} collections • {userData.collections.reduce((total, col) => total + col._count.vinyls, 0)} total records</p>
              </div>
            </div>
                      ...
                      <div className={styles.collectionPreview}>
                        {collection.vinyls.length > 0 ? (
                          <div className={styles.vinylPreviewGrid}>
                            {collection.vinyls.slice(0, 3).map((vinyl, index) => (
                              <div key={vinyl.id} className={styles.vinylPreview}>
                                {vinyl.imageUrl ? (
                                  <img 
                                    src={vinyl.imageUrl} 
