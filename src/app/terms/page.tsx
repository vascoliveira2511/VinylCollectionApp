        ...
        <div className={styles.contentSection}>
          <div className={styles.legalDocument}>
            ...
            <div className={styles.legalSection}>
              ...
              <p>
                By accessing and using Vinyl Collection ("the Service"), you
            ...
            <div className={styles.legalSection}>
              ...
              <p>Vinyl Collection is a web application that allows users to:</p>
              <ul>
            ...
            <div className={styles.legalSection}>
              ...
              <p>
                You retain ownership of the content you add to your collection
                (ratings, notes, etc.). However, you grant us a license to:
              </p>
              <ul>
                <li>Store and process your data to provide the Service</li>
                <li>
                  Display your content to users you've connected with as friends
                </li>
                <li>Use anonymized, aggregated data to improve the Service</li>
              </ul>
              <p>
                We respect your privacy and will not share your personal data
                without consent, except as outlined in our Privacy Policy.
              </p>
            </div>
            ...
            <div className={styles.legalSection}>
              ...
              <p>
                The Service integrates with third-party services (Discogs,
                Spotify, Google). Your use of these services is subject to their
            ...
            <div className={styles.legalSection}>
              ...
              <p>
                ...
                or continuously available. We disclaim all warranties, express
                or implied, including merchantability and fitness for a
                particular purpose.
              </p>
            </div>
            ...
            <div className={styles.legalSection}>
              ...
              <p>
                ...
                Service, including loss of data, profits, or business
                interruption.
              </p>
            </div>
            ...
            <div className={styles.legalSection}>
              ...
              <p>
                ...
                with the laws of Portugal. Any disputes shall be resolved in the
                courts of Portugal.
              </p>
            </div>
