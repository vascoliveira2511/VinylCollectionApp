...
export default function StatusButtons({ discogsId, onStatusChange }: StatusButtonsProps) {
  ...
  return (
    <>
      <button
        ...
        className={`${styles.statusButton} ${userStatus === "want" ? styles.statusActive : ""}`}
      >
      ...
      <button
        ...
        className={`${styles.statusButton} ${userStatus === "have" ? styles.statusActive : ""}`}
      >
