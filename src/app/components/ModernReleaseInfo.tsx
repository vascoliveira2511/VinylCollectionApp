...
export default function ModernReleaseInfo(props: ModernReleaseInfoProps) {
  const [activeTab, setActiveTab] = useState<
    "overview" | "details" | "credits" | "tracks"
  >("overview");
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              backgroundColor:
                activeTab === tab.key ? "var(--ctp-surface1)" : "transparent",
              color:
                activeTab === tab.key
                  ? "var(--ctp-text)"
                  : "var(--ctp-subtext1)",
              ...
              <div style={{ display: "grid", gap: "8px", fontSize: "0.9em" }}>
                {props.labels && props.labels.length > 0 && (
                  <div>
                    <strong>Label:</strong>
                    <div
                      style={{ marginTop: "2px", color: "var(--ctp-subtext1)" }}
                    >
                ...
                {props.tracklist.map((track, index) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: "8px 12px",
                      backgroundColor:
                        index % 2 === 0 ? "var(--ctp-surface0)" : "transparent",
                      borderRadius: "4px",
                      alignItems: "center",
                    }}
                  >
                    ...
                    <span
                      style={{ fontSize: "0.9em", color: "var(--ctp-text)" }}
                    >
                      {track.title}
                    </span>
                    {track.duration && (
