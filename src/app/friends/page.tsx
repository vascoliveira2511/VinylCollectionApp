                      ...
                      <div className={styles.userInfo}>
                        ...
                        <div className={styles.userActions}>
                          ...
                          {user.friendshipStatus === 'sent' && (
                            <span className={styles.statusText}>✉️ Request Sent</span>
                          )}
                          {user.friendshipStatus === 'received' && (
                            <span className={styles.statusText}>📥 Sent You Request</span>
                          )}
          ...
          <div className={styles.contentSection}>
            ...
            <div className={styles.tabNav}>
              <button 
                ...
                className={activeTab === 'friends' ? styles.tabActive : styles.tabInactive}
              >
                Friends ({friends.length})
              </button>
              <button 
                onClick={() => setActiveTab('received')}
                className={activeTab === 'received' ? styles.tabActive : styles.tabInactive}
              >
                Requests ({receivedRequests.length})
              </button>
              <button 
                onClick={() => setActiveTab('sent')}
                className={activeTab === 'sent' ? styles.tabActive : styles.tabInactive}
              >
                    ...
                    friends.map(friendship => (
                      <div key={friendship.id} className={styles.friendCard}>
                        ...
                        <div className={styles.friendInfo}>
                          ...
                          <p>Friends since {new Date(friendship.createdAt).toLocaleDateString()}</p>
                        </div>
